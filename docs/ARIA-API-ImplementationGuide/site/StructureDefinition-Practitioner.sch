...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'http://varian.com/fhir/v1/StructureDefinition/person-gender']) &lt;= 1">extension with URL = 'http://varian.com/fhir/v1/StructureDefinition/person-gender': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://varian.com/fhir/v1/StructureDefinition/practitioner-role']) &lt;= 1">extension with URL = 'http://varian.com/fhir/v1/StructureDefinition/practitioner-role': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://varian.com/fhir/v1/StructureDefinition/defaultServiceOrganization']) &lt;= 1">extension with URL = 'http://varian.com/fhir/v1/StructureDefinition/defaultServiceOrganization': maximum cardinality of 'extension' is 1</sch:assert>
