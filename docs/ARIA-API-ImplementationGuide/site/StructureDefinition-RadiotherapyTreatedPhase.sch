...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile RadiotherapyTreatedPhase
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'fractionsDelivered']) &lt;= 0">extension with URL = 'fractionsDelivered': maximum cardinality of 'extension' is 0</sch:assert>
