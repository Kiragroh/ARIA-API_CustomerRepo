...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile RadiotherapyPhasePrescription
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-fractions-prescribed']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-fractions-prescribed': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.siemens-healthineers.com/fhir/R4/StructureDefinition/shs-radiotherapy-bolus-extension']) &lt;= 1">extension with URL = 'http://fhir.siemens-healthineers.com/fhir/R4/StructureDefinition/shs-radiotherapy-bolus-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-treatment-applicator-type']) &lt;= 0">extension with URL = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-treatment-applicator-type': maximum cardinality of 'extension' is 0</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'fractionDose']) &lt;= 1">extension with URL = 'fractionDose': maximum cardinality of 'extension' is 1</sch:assert>
