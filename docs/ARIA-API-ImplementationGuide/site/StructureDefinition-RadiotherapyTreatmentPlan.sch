...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile RadiotherapyTreatmentPlan
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-dicom-reference']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-dicom-reference': maximum cardinality of 'extension' is 1</sch:assert>
